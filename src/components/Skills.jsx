...
export default function Skills() {
  return (
    ...
    >
      ...
      <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[700px] h-[320px] bg-pink-500/10 blur-3xl" />
      <div className="absolute bottom-[-100px] left-1/2 -translate-x-1/2 w-[700px] h-[320px] bg-blue-500/10 blur-3xl" />

      <div className="max-w-6xl mx-auto px-4 relative z-10">
        {/* LABEL */}
        <div className="flex items-center justify-center md:justify-start gap-3 mb-6 sm:mb-8">
            ...
            <div key={index}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-4">
                {group.items.map((item, i) => (
                  ...
                  >
                    <div
                      className={`h-full flex flex-col items-center justify-center gap-3 p-4 rounded-[16px] bg-[#080808]/95 border border-white/10 backdrop-blur ${group.glow} hover:border-white/20 hover:-translate-y-1 transition duration-300`}
                    >
                      <img
                        src={item.icon}
                        alt={item.name}
                        className="w-9 h-9 opacity-75 group-hover:opacity-100 group-hover:scale-110 transition duration-300"
                      />
